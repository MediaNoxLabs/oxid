...
standalone-public-balances:
    OXID_ENABLE_LIVE_STANDALONE_BALANCES=1 cargo test -p oxid-composition standalone_funding_tests::public_standalone_genesis_balances_are_exact -- --ignored --exact
