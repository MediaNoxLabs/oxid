...
if rg -a -q \
  'OXID_PREPROD_MASTER_SEED_HEX|OXID_ENABLE_LIVE_PREPROD_E2E|OXID_PREPROD_E2E_CASE_INDEX|OXID_PREPROD_FUNDING_MANIFEST_V1|Preprod E2E wallet A|Preprod E2E wallet B' \
  "$release_binary"; then
