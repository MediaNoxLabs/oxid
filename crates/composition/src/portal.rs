...
use oxid_adapter_identity_ingress::NativeIdentityLinkIngress;
...
mod tests {
    ...
    fn deployment(issuer_origin: &str, resolver_origin: &str) -> PortalDeploymentManifest {
        ...
        let bytes = format!(
            concat!(
                r#"{{"integrationCommit":"25499870f84d77173c46e4af3021311decfb840b","integrationTree":"2d845d2293603dfd8adce5362c8a9941e6ba78a9","issuerDid":"did:midnight:undeployed:0123456789abcdef0123456789abcdef0123456789abcdef0123456789abcdef","issuerJubjubJwk":{jwk},"issuerJubjubJwkSha256":"{jwk_digest}","issuerMethod":"did:midnight:undeployed:0123456789abcdef0123456789abcdef0123456789abcdef0123456789abcdef#key-assert","issuerOrigin":"{issuer_origin}","issuerResolverOrigin":"{resolver_origin}","provenanceSha256":"63d2dd182f1a315d8fe7677ae6481aecebd2fd9cff709cc438b6c0261a3cf4c7","schema":"oxid-portal-deployment-v3"}}"#
            ),
            jwk = jwk,
