...
enforces a five-minute ceiling and an attested effort floor of `medium`; use the
copyable command in `docs/dev-loop-stability.md` rather than relying on older
local invocations or evidence. It
