...
unshielded undeployed NIGHT rail. That rail's QR carries the closed versioned
receive request accepted by the Send flow, while Copy and Share retain the
validated raw undeployed Bech32m fallback. The sheet labels the profile,
Midnight network, route class, and selected asset before export.
