...
| [0104](https://github.com/MediaNoxLabs/oxid/blob/233eda9d6c80e8554d83b4b1160b224da5a5ed65/docs/adr/0104-regrow-incoming-adapters-behind-capability-facades.md) Regrow oversized adapters behind capability façades | Accepted | §§3, 6, 13–14, 18–19; issue #145 | Governing policy and source-size baseline recorded; headless then desktop Dioxus source-module decomposition is first, composition and Midnight remain later, and no crate extraction is authorized |
