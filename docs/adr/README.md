...
| [0079](0079-spend-shielded-assets-from-current-adapter-private-state.md) Spend shielded assets from current adapter-private state | Accepted | §§3–8, 12–13, 16–18, 21 and issues #2/#59/#91 | Fresh-sync-gated canonical Zswap planning reuses staged authorization, DUST proving, and durable recovery; guarded real standalone finality/adapter-reconstruction/nullifier evidence is complete while fresh-wallet DUST registration and physical gates remain open |
...
| [0099](0099-register-protected-dust-keys-before-fresh-wallet-submission.md) Register protected DUST keys before fresh-wallet submission | Accepted | §§3–8, 12–13, 16–18, 21; prototype onboarding plan; ledger registration semantics; issues #2/#92 | Implemented in repository/headless: a distinct prepare/consent/authorize/submit port registers only current owned NIGHT inputs through protected role-0/role-2 custody; a fresh wallet intentionally starts with zero DUST, and authoritative generated-DUST observation remains a separate spend-readiness gate |
...
ADR-0099 accepts a distinct protected DUST-registration capability instead of
...
repository/headless path is implemented; funded preprod, mobile, restart, and
physical-device acceptance evidence remain in progress.
