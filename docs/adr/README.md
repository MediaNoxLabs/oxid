...
| [0025](0025-persist-public-wallet-profile-metadata.md) Persist public profile metadata separately from secrets | Accepted | §§3, 7, 12–13, 17 and issue #1 | Bounded owner-private atomic JSON profile metadata, selection, restore, UI, and headless flows implemented |
...
| [0106](0106-adopt-seedless-ux-with-multi-factor-recovery.md) Adopt a seedless UX with multi-factor recovery | Proposed | Midnight Passport vision; ADR-0017/0074–0078/0090/0105; issues #359/#364 | Research compares passkey PRF, platform/cloud recovery, peer devices, MPC, guardian recovery, and account rotation; no provider or implementation is approved |
...
recovery factors. The target Passport model replaces universal-root recovery
with peer device authority, contract-level rotation, and reviewed BUSS/ANARKey
guardian recovery. Platform cloud and managed MPC remain optional, disclosed
profiles rather than sole recovery authority; no implementation is approved
while the ADR is Proposed.
