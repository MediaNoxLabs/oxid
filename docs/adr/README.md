...
| [0102](0102-admit-pinned-portal-final-in-headless-development.md) Admit pinned Portal Final issuance in headless development | Accepted | ADR-0039/0101; issue #124; Portal PR #17 / `integration@925ec8d` | Strict authenticated native-headless issuance and restore remain development-only; real Portal headless/iOS/Android evidence runs locally at one Oxid head, while hosted CI validates only public/static harness contracts without private source authority or evidence upload |
| [0103](0103-admit-pinned-portal-final-in-standalone-local-mobile-tests.md) Admit pinned Portal Final in standalone-local mobile tests | Accepted | ADR-0039/0097/0101/0102; issue #124; Portal `integration@925ec8d` | Compile-gated iOS Simulator/Android QEMU Portal flows are orchestrated locally after headless with each standard smoke, atomic same-head evidence validation/publication, and closed exclusions for production/ordinary-mobile/native-custody/tailnet/physical/WASM paths |
