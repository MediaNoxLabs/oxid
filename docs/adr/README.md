...
| [0112](0112-adopt-private-docker-sandboxes-as-an-opt-in-pi-deploy-target.md) Adopt private Docker Sandboxes as an opt-in Pi deploy target | Accepted | ADR-0022/0096/0107; issues #198/#227/#655/#763 | Pins `@stixxert/pi-docker-sandbox@1.1.6` but loads its private Docker deploy target only through a fail-closed launcher; full tool execution waits for a pinned Nix template and sandbox-local Git evidence |
