...
| [0111](0111-keep-testkit-in-tree-and-reserve-public-replay-references.md) Keep testkit in-tree and reserve public replay references | Proposed | ADR-0003–0005/0020/0030–0033/0096/0098; issues #115/#116/#518 | Reserves a non-published in-tree `oxid-testkit`, keeps small synthetic fixtures in Oxid, and defers signed Preview/PreProd replay-reference releases to #116 compatibility proof; Mainnet remains excluded |
