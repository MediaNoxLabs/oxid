...
| [0099](0099-expose-an-agent-tool-surface-over-mcp.md) Agent tool surface over MCP | Proposed | §§1, 3–7, 11–13, 16, 18, 21 and issues #69/#70 | Zero-dependency stdio bridge in apps/oxid-mcp derives its tools from the capability manifest and excludes every consent, authorization, and signing ceremony; production SDK adoption and the policy engine remain issue #70 |
