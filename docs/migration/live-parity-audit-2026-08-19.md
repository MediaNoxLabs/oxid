...
| Shielded sync and spending | Implemented; funded headless standalone E2E proven; protected DUST registration implemented but live write unproven | `crates/adapters/midnight/src/shielded_sync.rs`, `crates/adapters/midnight/src/shielded_transport.rs`, `crates/adapters/midnight/src/transaction.rs`, `crates/composition/src/standalone_funding_tests.rs`, ADR-0079/#91 and ADR-0100/#92 | Successful amount-observed PreProd registration-to-shielded-spend evidence, funded mobile/native custody, checkpoint-aware journal compaction (#93), and physical proof budgets (#30) |
...
fresh-wallet shielded spend** (#92); safe
