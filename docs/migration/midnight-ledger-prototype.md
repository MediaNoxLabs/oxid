...
with `proof_unavailable`. ADR-0048 first reloads the credential-bound Jubjub
...
explicit same-method rotation semantics. It cannot construct a `vp_token` until
credential-family proof execution and an independent proof verifier are wired.
